...
public class PilotsCRUD {
    ...
    public static void createPilot (Piloto piloto) {
        String sql = "INSERT INTO drivers (driverid, code, forename, surname, dob, nationality, constructorid, url) VALUES ("
                + "'" + piloto.getDriverID() + "', "
                + "'" + piloto.getCode() + "', "
                + "'" + piloto.getForename() + "', "
                + "'" + piloto.getSurname() + "', "
                + "'" + piloto.getDob() + "', "
                + "'" + piloto.getNationality() + "', "
                + "'" + piloto.getConstructorid() + "', "
                + "'" + piloto.getUrl() + "')";
    ...
    public static void readPilot (int driverid) {
        ...
        try (Connection conn = DriverManager.getConnection(url, usuario, password)) {
            ...
            while (rs.next()) {
                ...
                piloto.setConstructorid(rs.getInt("constructorid"));
