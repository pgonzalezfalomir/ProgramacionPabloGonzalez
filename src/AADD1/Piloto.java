...
public class Piloto {
    ...
    private final int CONSTRUCTOR_ID_DEFAULT = 1;
    private final String URL_DEFAULT = "http://en.wikipedia.org/wiki/Pablo_Gonzalez";

    // constructores
    public Piloto (int driverID, String code, String forename, String surname, String dob, String nationality, int constructorid, String url) {
    ...
    public Piloto () {
        ...
        this.constructorid = CONSTRUCTOR_ID_DEFAULT;
